...
function App() {
  ...
  useEffect(() => {
    ...
    Axios.get("https://food-delivery-app-fullstack-git-main-iamalinaaa.vercel.app/", { crossdomain: true }).then(
      (response) => {
  ...
  useEffect(() => {
    Axios.get("https://food-delivery-app-fullstack-git-main-iamalinaaa.vercel.app/coupons", { crossdomain: true }).then(
      (response) => {
